...
try:
    ...
    print('\n \033[1;91m[\033[1;93mTVAHMED\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
...
os.system('xdg-open https://www.//youtube.com/@missdesinar?si=NrDR73_ssNHoBxUm')
def logo():
    os.system('clear')
    print(f"""                   {green}┏━━━━━━━━━━━━━━━━━━━┓{blue}
                   {green}┃{white}{faltu}AHMED(SHAR)(BRAND🕶️){pvt}{green}┃
{green}╔━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━┳━━━━━┻━━━━━━━━━━━━━━━━━━━╗
{green}┃{white}{green}{rad}{yellow}{cyan}{yelloww} {rad}╔═╗╔═╗╔═╗╔═╗╔╦╗{green}┃{purple}CEO {yelloww}: {yellow} AHMED SHAR                  {green}┃
{green}┃{white}{green}{rad}{yellow}{cyan} {yelloww}{yellow}X{white}╚═╗║╣ ╠╣ ╠═╣ ║{green} ┃{purple}CEO {yelloww}: {green}SHAR SARKER       {green}┃
{green}┃{white}{green} {rad} {yellow}{cyan}{yelloww}{rad}╚═╝╚═╝╚  ╩ ╩ ╩ {green}┃{purple}GIT {yelloww}: {cyan}SHAR-AHMED.        {green}┃
{green}┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+923160114715{green}┃  {yelloww}VERSION {green}: {rad}1.2  {green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
def AHMED():
    ...
    _____AHMED_____ = input(f'{white}[{green}+{white}] {green}SELECT : {yelloww}')
    if _____AHMED_____ in ['A','a','01','1']:
        os.system('xdg-open https://www.facebook.com/prince king hu yawr')
        ___uids___()
    elif _____AHMED_____ in ['B','b','02','2']:
        os.system('xdg-open https://www./youtube.com/shorts/q_s8_Eg79ds?feature=shared')
    elif _____AHMED_____ in ['C','c','03','3']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');AHMED()
...
def ___uids___():
    ...
    os.system('xdg-open https://github.com/SHAR-AHMED')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=30) as SHARAHMED:
        os.system('clear')
        logo()
        tl = str(len(user))
        ...
        for love in user:
           ...
           SHARAHMED.submit(___random___,ids,passlist)
    print('')
    linex()
